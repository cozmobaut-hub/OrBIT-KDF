...
def chi_square_first_byte(kdf_func, num_samples=20000):
    ...
    print(f"\n=== Hyper KDF: Chi-square on first byte over {num_samples} samples ===")
...
def measure_throughput(kdf_func, duration=1.0):
    ...
    rate = iters / elapsed
    print(f"\n=== Hyper KDF: Throughput over {elapsed:.2f} s ===")
...
if __name__ == "__main__":
    ...
    chi_square_first_byte(derive_fractal_key_hyper, num_samples=20000)

    # 2) Throughput test
    measure_throughput(derive_fractal_key_hyper, duration=1.0)
