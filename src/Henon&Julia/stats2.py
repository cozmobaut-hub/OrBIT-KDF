...
from main import derive_fractal_key_henon  # Henon+Julia KDF
...
if __name__ == "__main__":
    ...
    chi_square_first_byte(derive_fractal_key_henon, num_samples=50000)

    # 2) Throughput test
    measure_throughput(derive_fractal_key_henon, duration=1.0)
